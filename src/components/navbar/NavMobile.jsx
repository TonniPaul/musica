  ...
  return (
    ...
    >
      <div className="flex-column">
        ...
        <NavLink to="playlist" className="nav-links">
          <div className="mobile-gap">
            <svg
              className="svg-icons"
              width="22"
        ...
        <div className="mobile-gap">
          <NavLink to="radio" className="nav-links mobile-gap">
            <svg
              className="svg-icons"
              width="22"
              height="22"
        ...
        <div className="mobile-gap">
          <NavLink to="videos" className="nav-links mobile-gap">
            <svg
              className="svg-icons"
              width="22"
              height="22"
      ...
      <div className="flex-column">
        <div className="mobile-gap">
          <NavLink to="profile" className="nav-links mobile-gap">
            <svg
              className="svg-icons"
              width="22"
              height="22"
        ...
        <div className="mobile-gap ">
          <NavLink to="log-out" className="nav-links mobile-gap">
            <svg
              className="svg-icons"
              width="20"
              height="20"
