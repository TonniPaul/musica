      ...
      >
        <div className="flex logo-gap">
          {!isOpen ? (
            ...
            <span
              className="material-symbols-outlined x hide-0n-desktop"
              onClick={handleClose}
            >
              close
            </span>
          ...
          <div className="flex-column top">
            <div className="mobile-gap">
              <NavLink to="/home">
                ...
                <p className="hide-0n-desktop icon-txt">Home</p>
              </NavLink>
            </div>
            <div className="mobile-gap">
              <NavLink to="/playlist">
                ...
                <p className="hide-0n-desktop icon-txt"> My collection</p>
              </NavLink>
            </div>
            <div className="mobile-gap">
              <NavLink to="radio">
                ...
                <p className="hide-0n-desktop icon-txt">Radio</p>
              </NavLink>
            </div>
            ...
            <div className="mobile-gap">
              <NavLink to="videos">
                ...
                <p className="hide-0n-desktop icon-txt">Music video</p>
              </NavLink>
            </div>
          </div>
          <div className="flex-column top bottom">
            <div className="mobile-gap">
              <NavLink to="profile">
                ...
                <p className="hide-0n-desktop icon-txt">Profile</p>
              </NavLink>
            </div>
            <div className="mobile-gap ">
              <NavLink to="log-out">
                ...
                <p className="hide-0n-desktop icon-txt">Log out</p>
              </NavLink>
            </div>
          </div>
        </div>
